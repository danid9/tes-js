...
async function getVLESSConfig(path, hostName, proxyIP) {
    try {
        ...
        const vlessTls = `vless://RIFKY-CELL\u0040${hostName}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=${pathFixed}#${isp} (${country_code})`;
        const vlessNtls = `vless://RIFKY-CELL\u0040${hostName}:80?path=${pathFixed}&security=none&encryption=none&host=${hostName}&fp=randomized&type=ws&sni=${hostName}#${isp} (${country_code})`;
